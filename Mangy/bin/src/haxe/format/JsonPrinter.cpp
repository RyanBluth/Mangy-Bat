...
{
HX_STACK_FRAME("haxe.format.JsonPrinter","new",0xeb68de75,"haxe.format.JsonPrinter.new","C:\\HaxeToolkit\\haxe\\std/haxe/format/JsonPrinter.hx",17,0x660ed7d4)
HX_STACK_THIS(this)
...
{
		HX_STACK_FRAME("haxe.format.JsonPrinter","write",0x755dea34,"haxe.format.JsonPrinter.write","C:\\HaxeToolkit\\haxe\\std/haxe/format/JsonPrinter.hx",40,0x660ed7d4)
		HX_STACK_THIS(this)
		HX_STACK_ARG(k,"k")
		HX_STACK_ARG(v,"v")
		HX_STACK_LINE(41)
							...
							if (((c == hx::ClassOf< ::haxe::ds::StringMap >()))){
								...
								struct _Function_6_1{
									inline static Dynamic Block( ){
										HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","C:\\HaxeToolkit\\haxe\\std/haxe/format/JsonPrinter.hx",78,0x660ed7d4)
										{
...
{
		HX_STACK_FRAME("haxe.format.JsonPrinter","fieldsString",0x974bd375,"haxe.format.JsonPrinter.fieldsString","C:\\HaxeToolkit\\haxe\\std/haxe/format/JsonPrinter.hx",128,0x660ed7d4)
		HX_STACK_THIS(this)
		HX_STACK_ARG(v,"v")
...
{
		HX_STACK_FRAME("haxe.format.JsonPrinter","quote",0x02f6a091,"haxe.format.JsonPrinter.quote","C:\\HaxeToolkit\\haxe\\std/haxe/format/JsonPrinter.hx",153,0x660ed7d4)
		HX_STACK_THIS(this)
		HX_STACK_ARG(s,"s")
		HX_STACK_LINE(155)
...
{
		HX_STACK_FRAME("haxe.format.JsonPrinter","quoteUtf8",0x88683e62,"haxe.format.JsonPrinter.quoteUtf8","C:\\HaxeToolkit\\haxe\\std/haxe/format/JsonPrinter.hx",185,0x660ed7d4)
		HX_STACK_THIS(this)
		HX_STACK_ARG(s,"s")
		HX_STACK_LINE(186)
		...
		Void run(int c){
			HX_STACK_FRAME("*","_Function_1_1",0x5200ed37,"*._Function_1_1","C:\\HaxeToolkit\\haxe\\std/haxe/format/JsonPrinter.hx",188,0x660ed7d4)
			HX_STACK_ARG(c,"c")
			{
				HX_STACK_LINE(188)
				switch( (int)(c)){
...
::String JsonPrinter_obj::print( Dynamic o,Dynamic replacer,::String space){
	HX_STACK_FRAME("haxe.format.JsonPrinter","print",0x6d8fd582,"haxe.format.JsonPrinter.print","C:\\HaxeToolkit\\haxe\\std/haxe/format/JsonPrinter.hx",5,0x660ed7d4)
	HX_STACK_ARG(o,"o")
	HX_STACK_ARG(replacer,"replacer")
	HX_STACK_ARG(space,"space")
	HX_STACK_LINE(6)
